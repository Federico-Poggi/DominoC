...
// FUNZIONE PER RUOTARE UNA TESSERA E DECIDERE QUALE NUMERO DELLA TESSERA ACCOPPIARE
...
// PUSH HEAD TESSERA (INSERISCE LA TESSARA DAL "LATO SINISTRO" DELL'ARRAY)
...
// PUSH FOOTER TESSERA (INSERISCE LA TESSARA DAL "LATO DESTRO" DELL'ARRAY)
